...
class DatabaseHelper extends AbstractHelper
{
    ...
    public function detectDbSettings(OutputInterface $output)
    {
        ...
        if (!is_readable($configFile)) {
            throw new UnexpectedValueException('app/etc/local.xml is not readable');
        }
    ...
    /**
     * obtain maysql variable value from the database connection.
     *
     ...
     *                            magento database configuratio. defaults to false.
     *
     * @return array
